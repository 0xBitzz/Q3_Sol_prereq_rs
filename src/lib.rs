...
mod tests {
  ...
  use solana_sdk::{
    bs58, message::Message, pubkey::Pubkey, signature::{
      self, read_keypair_file, Keypair, Signer
    },
    signer::keypair, system_program, transaction::{self, Transaction}
  };
  ...
  fn consume_idl() {
    ...
    let args = CompleteArgs{github: b"0xBitzz".to_vec()};
